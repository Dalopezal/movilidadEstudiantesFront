...
import { AsignacionEstrategiaComponent } from '../asignacion-estrategia/asignacion-estrategia.component';
import { SeguimientoEstrategiaComponent } from '../seguimiento-estrategia/seguimiento-estrategia.component';

@Component({
  selector: 'app-estrategia-plan',
  imports: [
    CommonModule,
    FormsModule,
    HttpClientModule,
    ...
    MatIconModule,
    MatButtonModule,
    AsignacionEstrategiaComponent,
    SeguimientoEstrategiaComponent
  ],
  templateUrl: './estrategia-plan.component.html',
  styleUrl: './estrategia-plan.component.css',
  providers: [ConfirmationService]
})
export class EstrategiaPlanComponent implements OnInit, OnDestroy {
